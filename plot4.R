...
with(edata, {
    plot(Global_active_power ~ date_time, data = edata, type = "l", xlab = "", ylab = "Global Active Power")
    ...
    plot(Voltage ~ date_time, data = edata, type = "l", xlab = "datetime", ylab = "Voltage")
    plot(Global_reactive_power ~ date_time, data = edata, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
dev.off()})